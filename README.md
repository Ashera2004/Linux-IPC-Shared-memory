...
<img width="847" height="611" alt="exp6_os" src="https://github.com/user-attachments/assets/d89f3a37-3d11-4827-b4f7-fb7c6274db5a" />



# RESULT:

Thus the program to implement the communication between  two processes using shared memory API  is written and verified using C programming.
